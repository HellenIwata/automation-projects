...
def create_user():
    ...
    if not server_id or not user_name or not role_arn or not policy_arn or not home_directory or not ssh_key:
...
def delete_user():
    ...
    if not server_id or not user_name:
        print("Both Server ID and User Name are required.")
        return
